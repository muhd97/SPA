...
vector<int> PKBFollowsHandler::getBefore(PKBDesignEntity beforeType, int afterIndex)
{
    vector<int> res;
...
vector<int> PKBFollowsHandler::getBefore(PKBDesignEntity beforeType, PKBDesignEntity afterType)
{
    vector<int> res;
...
vector<int> PKBFollowsHandler::getAfter(PKBDesignEntity afterType, int beforeIndex)
{
    vector<int> res;
...
vector<int> PKBFollowsHandler::getAfter(PKBDesignEntity beforeType, PKBDesignEntity afterType)
{
    vector<int> res;
...
set<pair<int, int>> PKBFollowsHandler::getAfterPairs(PKBDesignEntity beforeType, PKBDesignEntity afterType)
{
...
bool PKBFollowsHandler::getFollows()
{
...
bool PKBFollowsHandler::getFollowsT(int leftStmtNo, int rightStmtNo)
{
...
// getAfterT
const vector<int> PKBFollowsHandler::getFollowsT(int leftStmtNo, PKBDesignEntity rightType)
{
    return mpPKB->followsTIntSynTable[leftStmtNo][rightType];
}

bool PKBFollowsHandler::getFollowsTIntegerUnderscore(int leftStmtNo)
{
...
{
    if (!mpPKB->statementExists(rightStmtNo))
        throw runtime_error("Statement doesn't exist: " + to_string(rightStmtNo));
...
const set<pair<int, int>> &PKBFollowsHandler::getFollowsT(PKBDesignEntity leftType, PKBDesignEntity rightType)
{
    return mpPKB->followsTSynSynTable[make_pair(leftType, rightType)];
}

/*PRE-CONDITION: TargetFolllowsType IS a container type. */
const unordered_set<int> &PKBFollowsHandler::getFollowsTSynUnderscore(PKBDesignEntity leftType)
{
    return mpPKB->followsTSynUnderscoreTable[leftType];
}

/*Use for Follows*(_, INT) */
bool PKBFollowsHandler::getFollowsTUnderscoreInteger(int rightStmtNo)
{
...
unordered_set<int> PKBFollowsHandler::getFollowsTUnderscoreSyn(PKBDesignEntity rightType)
{
...
bool PKBFollowsHandler::getStatementBefore(PKBStmt::SharedPtr &statementAfter, PKBStmt::SharedPtr &result)
{
...
bool PKBFollowsHandler::getStatementAfter(PKBStmt::SharedPtr &statementBefore, PKBStmt::SharedPtr &result)
{
    // find the rightStatement before in the stmt's group
