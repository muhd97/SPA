...
// NextT(p, q)
void PKBNextBipHandler::getNextTStatementList(vector<shared_ptr <Statement>> list, StatementType from, StatementType to, int fromIndex,
...
set<pair<int, int>> PKBNextBipHandler::getNextBipCallStatements(shared_ptr<PKB> pkb, StatementType from, StatementType to, int fromIndex, int toIndex, bool canExitEarly)
{
...
void PKBNextBipHandler::getNextBipTStatementList(vector<shared_ptr <Statement>>& list, StatementType from, StatementType to, int fromIndex, int toIndex,
...
void PKBNextBipHandler::getNextBipTProcedure(shared_ptr<Procedure>& proc, StatementType from, StatementType to, int fromIndex,
...
set<pair<int, int>> PKBNextBipHandler::getNextBipT(shared_ptr<Program>& program, StatementType from, StatementType to, int fromIndex,
