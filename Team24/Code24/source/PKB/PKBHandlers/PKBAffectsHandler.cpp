...
// ======================================================================================================
// Affects
bool PKBAffectsHandler::handleAffectsAssign(int index, bool includeAffectsT,
...
pair<set<pair<int, int>>, set<pair<int, int>>> PKBAffectsHandler::getAffects(bool includeAffectsT, int referenceStatement) {
	affectsList.clear();
	affectsTList.clear();
	affectsTHelperTable.clear();
	affectsTHelperTable2.clear();
