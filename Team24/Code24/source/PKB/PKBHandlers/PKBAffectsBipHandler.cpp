...
// ======================================================================================================
// Affects
bool PKBAffectsBipHandler::handleAffectsAssignBIP(int index, bool includeAffectsT,
...
void PKBAffectsBipHandler::handleAffectsReadBIP(int index, bool includeAffectsT,
                                                map<string, set<int>> &lastModifiedTable)
{
    PKBStmt::SharedPtr stmt;
    if (mpPKB->getStatement(index, stmt))
...
bool PKBAffectsBipHandler::handleAffectsCallBIP(int index, bool includeAffectsT,
                                                map<string, set<int>> &lastModifiedTable)
{
    PKBStmt::SharedPtr stmt;
    if (mpPKB->getStatement(index, stmt))
...
pair<set<pair<int, int>>, set<pair<int, int>>> PKBAffectsBipHandler::getAffectsBip(bool includeAffectsT)
{
    affectsList.clear();
    affectsTList.clear();
...
bool PKBAffectsBipHandler::computeAffectsBIP(const shared_ptr<BasicBlock> &basicBlock, bool includeAffectsT,
                                             map<string, set<int>> &lastModifiedTable,
                                             shared_ptr<BasicBlock> &lastBlock)
{
