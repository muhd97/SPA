...
public:
  ...
  static SharedPtr create(int statementIndex, PKBDesignEntity type,
                          set<PKBVariable::SharedPtr> uses,
  ...
  PKBGroup::SharedPtr getGroup() { return mBelongsTo; }
  ...
  vector<PKBGroup::SharedPtr> getContainerGroups() { return mContainerGroup; }
  ...
  int getUsedVariablesSize() { return mUses.size(); }

  set<PKBVariable::SharedPtr> getModifiedVariables() { return mModifies; }

  int getIndex() { return mIndex; }

  PKBDesignEntity getType() { return mType; }

  void setGroup(PKBGroup::SharedPtr belongsTo) { mBelongsTo = belongsTo; }
