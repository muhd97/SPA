...
StatementType PKBPQLNextBipHandler::getStatementType(PKBDesignEntity de)
{
	switch (de)
	{
...
// NextT(p, q)
void PKBPQLNextBipHandler::getNextTStatementList(vector<shared_ptr <Statement>> list, StatementType from, StatementType to, int fromIndex,
...
set<pair<int, int>> PKBPQLNextBipHandler::getNextBipCallStatements(shared_ptr<PKB> pkb, StatementType from, StatementType to, int fromIndex, int toIndex, bool canExitEarly)
{
...
// Use for NextBip(_, _)
bool PKBPQLNextBipHandler::getNextBipUnderscoreUnderscore()
{
...
unordered_set<int> PKBPQLNextBipHandler::getNextBipUnderscoreSyn(PKBDesignEntity to)
{
...
bool PKBPQLNextBipHandler::getNextBipUnderscoreInt(int toIndex)
{
...
set<pair<int, int>> PKBPQLNextBipHandler::getNextBipSynSyn(PKBDesignEntity from, PKBDesignEntity to)
{
...
unordered_set<int> PKBPQLNextBipHandler::getNextBipSynUnderscore(PKBDesignEntity from)
{
...
unordered_set<int> PKBPQLNextBipHandler::getNextBipSynInt(PKBDesignEntity from, int toIndex)
{
...
bool PKBPQLNextBipHandler::getNextBipIntInt(int fromIndex, int toIndex)
{
...
bool PKBPQLNextBipHandler::getNextBipIntUnderscore(int fromIndex)
{
...
unordered_set<int> PKBPQLNextBipHandler::getNextBipIntSyn(int fromIndex, PKBDesignEntity to)
{
...
// Case 1: NextBipT(_, _)
bool PKBPQLNextBipHandler::getNextBipTUnderscoreUnderscore()
{
	set<pair<int, int>> result =
...
unordered_set<int> PKBPQLNextBipHandler::getNextBipTUnderscoreSyn(PKBDesignEntity to)
{
...
bool PKBPQLNextBipHandler::getNextBipTUnderscoreInt(int toIndex)
{
	set<pair<int, int>> result =
...
set<pair<int, int>> PKBPQLNextBipHandler::getNextBipTSynSyn(PKBDesignEntity from, PKBDesignEntity to)
{
	return getNextBipT(mpPKB->program, getStatementType(from), getStatementType(to), 0, 0, false);
}

// Case 5: NextBipT(syn, _)
unordered_set<int> PKBPQLNextBipHandler::getNextBipTSynUnderscore(PKBDesignEntity from)
{
	set<pair<int, int>> result =
...
unordered_set<int> PKBPQLNextBipHandler::getNextBipTSynInt(PKBDesignEntity from, int toIndex)
{
	set<pair<int, int>> result =
...
bool PKBPQLNextBipHandler::getNextBipTIntInt(int fromIndex, int toIndex)
{
	set<pair<int, int>> result =
...
bool PKBPQLNextBipHandler::getNextBipTIntUnderscore(int fromIndex)
{
	set<pair<int, int>> result =
...
unordered_set<int> PKBPQLNextBipHandler::getNextBipTIntSyn(int fromIndex, PKBDesignEntity to)
{
	set<pair<int, int>> result =
...
void PKBPQLNextBipHandler::getNextBipTStatementList(vector<shared_ptr <Statement>>& list, StatementType from, StatementType to, int fromIndex, int toIndex,
...
void PKBPQLNextBipHandler::getNextBipTProcedure(shared_ptr<Procedure>& proc, StatementType from, StatementType to, int fromIndex,
...
set<pair<int, int>> PKBPQLNextBipHandler::getNextBipT(shared_ptr<Program>& program, StatementType from, StatementType to, int fromIndex,
