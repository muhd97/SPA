...
class AffectsHandler : public FollowsParentNextAffectsHandler
{
private:
...
public:
	AffectsHandler(shared_ptr<PKBPQLEvaluator>& evaluator, shared_ptr<SelectCl>& selectCl, shared_ptr<Affects>& affectsCl);
};
