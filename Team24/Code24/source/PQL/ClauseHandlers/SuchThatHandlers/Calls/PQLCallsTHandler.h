...
class CallsTHandler : public CallsCallsTHandler
{
  private:
  ...
  public:
    CallsTHandler(shared_ptr<PKBPQLEvaluator> &evaluator, shared_ptr<SelectCl> &selectCl, shared_ptr<CallsT> &callsTCl);
};
