...
class FollowsParentNextAffectsHandler : public SuchThatHandler
{
  ...
  protected:
    ...
    FollowsParentNextAffectsHandler(shared_ptr<PKBPQLEvaluator> &evaluator, shared_ptr<SelectCl> &selectCl,
                                    shared_ptr<StmtRef> leftArg, shared_ptr<StmtRef> rightArg);
