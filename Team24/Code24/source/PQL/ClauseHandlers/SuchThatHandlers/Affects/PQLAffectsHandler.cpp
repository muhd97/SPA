...
AffectsHandler::AffectsHandler(shared_ptr<PKBPQLEvaluator> &evaluator, shared_ptr<SelectCl> &selectCl,
                               shared_ptr<Affects> &affectsCl)
    : FollowsParentNextAffectsHandler(evaluator, selectCl, affectsCl->stmtRef1, affectsCl->stmtRef2)
{
}
