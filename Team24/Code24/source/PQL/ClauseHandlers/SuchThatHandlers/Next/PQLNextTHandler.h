...
class NextTHandler : public FollowsParentNextAffectsHandler
{
  private:
  ...
  public:
    NextTHandler(shared_ptr<PKBPQLEvaluator> &evaluator, shared_ptr<SelectCl> &selectCl, shared_ptr<NextT> &nextTCl);
};
