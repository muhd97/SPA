...
void WithHandler::evaluateWithFirstArgIdentSecondArgAttr(const std::string& leftVal, std::vector<std::shared_ptr<ResultTuple>>& toReturn)
{
...
void WithHandler::evaluateWithFirstArgAttrRefSecondArgInt(const std::shared_ptr<AttrRef>& leftAttrRef, std::vector<std::shared_ptr<ResultTuple>>& toReturn)
{
...
void WithHandler::evaluateWithFirstArgAttrRefSecondArgSyn(const std::shared_ptr<AttrRef>& leftAttrRef, std::vector<std::shared_ptr<ResultTuple>>& toReturn)
{
    const auto leftAttrNameType = leftAttrRef->getAttrName()->getAttrNameType();
    const string& rightSynString = rhs->getStringVal();
    const string& leftSynString = lhs->getAttrRef()->getSynonymString();
...
void WithHandler::evaluateWithFirstArgAttrRefSecondArgIdent(std::vector<std::shared_ptr<ResultTuple>>& toReturn, bool& retflag)
{
    retflag = true;
    /* By the pre-condiiton, we are guaranteed left attrRef is a STRING (NAME) type */
    const string& rightVal = rhs->getStringVal();
...
void WithHandler::evaluateWithFirstArgAttrRefSecondArgAttr(const std::shared_ptr<AttrRef>& leftAttrRef, std::vector<std::shared_ptr<ResultTuple>>& toReturn)
{
...
void WithHandler::evaluateWithFirstArgSynSecondArgAttr(std::vector<std::shared_ptr<ResultTuple>>& toReturn, const std::string& leftSynonymString)
{
    const auto rightAttrNameType = rhs->getAttrRef()->getAttrName()->getAttrNameType();
    const string& rightSynonymString = rhs->getAttrRef()->getSynonymString();
    const auto& temp1 = selectCl->getDesignEntityTypeBySynonym(rightSynonymString);
...
void WithHandler::evaluateWithFirstArgSynSecondArgSyn(std::vector<std::shared_ptr<ResultTuple>>& toReturn, const std::string& leftSynonymString)
{
...
void WithHandler::evaluateWithFirstArgSynSecondArgInt(std::vector<std::shared_ptr<ResultTuple>>& toReturn, const std::string& leftSynonymString)
{
