...
class FollowsHandler : public FollowsParentHandler
{
private:
...
public:
	FollowsHandler(shared_ptr<PKBPQLEvaluator>& evaluator, shared_ptr<SelectCl>& selectCl, shared_ptr<Follows>& followsCl);
};
