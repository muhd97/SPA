...
class FollowsTHandler : public FollowsParentHandler
{
private:
...
public:
	FollowsTHandler(shared_ptr<PKBPQLEvaluator>& evaluator, shared_ptr<SelectCl>& selectCl, shared_ptr<FollowsT>& followsTCl);
};
