...
class AffectsBipTHandler : public FollowsParentNextAffectsHandler
{
private:
...
public:
	AffectsBipTHandler(shared_ptr<PKBPQLEvaluator>& evaluator, shared_ptr<SelectCl>& selectCl, shared_ptr<AffectsBipT>& affectsBipTCl);
};
