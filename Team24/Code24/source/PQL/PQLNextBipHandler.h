...
class NextBipHandler : public FollowsParentNextAffectsHandler
{
private:
...
public:
	NextBipHandler(shared_ptr<PKBPQLEvaluator>& evaluator, shared_ptr<SelectCl>& selectCl, shared_ptr<NextBip>& nextBipCl);
};
