...
class NextBipTHandler : public FollowsParentNextAffectsHandler
{
private:
...
public:
	NextBipTHandler(shared_ptr<PKBPQLEvaluator>& evaluator, shared_ptr<SelectCl>& selectCl, shared_ptr<NextBipT>& nextCl);
};
