...
class ParentTHandler : public FollowsParentHandler
{
private:
...
public:
	ParentTHandler(shared_ptr<PKBPQLEvaluator>& evaluator, shared_ptr<SelectCl>& selectCl, shared_ptr<ParentT>& parentTCl);
};
